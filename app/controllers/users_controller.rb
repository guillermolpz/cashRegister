class UsersController < ApplicationController
  ...
  before_action :set_user, only: [:show, :new, :edit, :create, :update] # probably want to keep using this
  ...
  def user_params
    params.require(:user).permit(:name, :lastName, :username, :email, :password, :password_confirmation, roles: [])
  end
